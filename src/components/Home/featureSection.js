      ...
      <div className="max-w-7xl mx-auto lg:px-8 md:px-3">
        <div className="mx-auto max-w-7xl px-4 sm:mt-10 sm:px-6 md:mt-10 lg:mt-10 lg:px-0 xl:mt-10 flex flex-col lg:flex-row gap-3 lg:flex-justify">
          ...
          <div className="lg:w-1/2 sm:text-center lg:text-right flex flex-col justify-center">
            <h2 className="text-black text-4xl font-semibold">Proyectos</h2>
        ...
        <div className="mt-10 flex flex-row justify-space xxs:flex-col xs:flex-col sm:flex-row">
          <div className="w-2/6 bg-gradient-to-r from-pink to-purple p-8 rounded-xl m-5 xxs:w-full xs:w-full sm:w-2/6">
            <span className="text-black font-semibold font-montserrat text-4xl">
              Especialistas en <a target="_blank"
                    href="https://solidedge.siemens.com/"
                  >Solid Edge</a> y diseño técnico aplicado.
            </span>
            <div className="mt-5">
              <div>
                <p className="text-black text-2xl">Modelado 3D</p>
                <p className="text-black opacity-50 text-sm">Documentación técnica y planos para fabricación.</p>
              </div>
              <div className="mt-5">
                <p className="text-black text-2xl">Proyectos mecánicos con enfoque en automatización</p>
                <p className="text-black opacity-50 text-sm">Capacitaciones personalizadas en Solid Edge y herramientas de diseño técnico</p>
              </div>
            </div>
          </div>
          ...
          <div className="w-4/6 bg-dp p-8 rounded-xl m-5 xxs:w-full xs:w-full sm:w-4/6">
            <h2 className="text-white text-4xl">
              Empiece a crear experiencias únicas con MecaEdge Studio
            </h2>
        ...
        <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
          <div className="rounded-md">
            <a
              ...
              className="transition-all duration-500ms ease-in-out hover:ease-in-out w-full flex items-center justify-center px-8 py-3 text-base font-medium rounded-md text-center bg-purple text-white hover:text-black border border-purple hover:bg-transparent md:text-lg md:px-10"
            >
              Envía tus comentarios y consultas
            </a>
          </div>
        </div>
      </div>
      ...
      <Fade bottom cascade>
        <div className="mt-10 flex flex-row justify-space xxs:flex-col xs:flex-col sm:flex-row content-center justify-center align-middle text-center">
          <div className="w-1/3 bg-gradient-to-r from-pink to-purple p-8 rounded-xl m-5 xxs:w-full xs:w-full sm:w-1/3">
            ...
            <h4 className="mt-10 text-black opacity-70 text-xl">Lanzamientos</h4>
          </div>

          <div className="w-1/3 bg-dp p-8 rounded-xl m-5 xxs:w-full xs:w-full sm:w-1/3">
            <h3 className="text-white text-2xl">Proyectos</h3>
