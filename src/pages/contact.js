...
const Contact = () => {
  return (
    <Layout>
      <Seo
        title="Contacto - Meca Edge Studio"
        description="Contáctanos para transformar y hacer realidad tus ideas."
      ></Seo>

      <div className="max-w-7xl mx-auto mt-10 flex text-white xxs:flex-col sm:flex-row">
        <Fade duration={1200}>
          <div className="bg-dp opacity-70 p-10 rounded-xl w-3/4 m-5 w-auto">
            <h1 className="text-3xl text-white">CONTACTO</h1>
            ...
            <p className="text-lg mt-2 opacity-70 w-3/4 xxs:text-xs xxs:w-full sm:text-sm sm:w-3/4">
              Trnasformamos y hacemos realidad tus ideas. Si tienes alguna
              pregunta, comentario o simplemente quieres saludar, no dudes en
              contactarnos. 
            </p>
                ...
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-3">
                  <div className="flex items-start">
                    ...
                    <div className="ml-2 grow">
                      ...
                      <p className="text-neutral-500 mb-2">
                        <a href="mailto:mecaedgestudio@gmail.com?subject=Me contacto para solicitar ayuda en...">
                          mecaedgestudio@gmail.com
                        </a>
                      </p>
                    </div>
                  </div>
                ...
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-3">
                  <div className="align-start flex">
                    ...
                    <div className="ml-2 grow">
                      ...
                      <p className="text-neutral-500 mb-2">Buenos Aires - Argentina</p>
                    </div>
                  </div>
                </div>
